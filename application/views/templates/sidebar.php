            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item <?= active_menu('siswa'); ?>" href="<?= base_url('siswa') ?>">Siswa</a>
                        <a class="collapse-item <?= active_menu('kelas'); ?>" href="<?= base_url('kelas') ?>">Kelas</a>
                        <?php if ($this->session->userdata('is_admin')) : ?>
                            <a class="collapse-item <?= active_menu('guru')  ?>" href="<?= base_url('guru') ?>">Guru</a>
                            <a class="collapse-item <?= active_menu('jurusan') ?>" href="<?= base_url('jurusan') ?>">Jurusan</a>
                        <?php endif; ?>
                    </div>
                </div>
            </li>
